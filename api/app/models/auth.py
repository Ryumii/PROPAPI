...
class UserAccount(Base, TimestampMixin):
    ...
    plan: Mapped[str] = mapped_column(String(20), nullable=False, server_default="flex")
...
class ApiKey(Base):
    ...
    plan: Mapped[str] = mapped_column(String(20), nullable=False, server_default="flex")
    monthly_limit: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
